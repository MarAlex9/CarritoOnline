...
<body>
    <div id="wrapper">
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
					...
					<li><a href="shop.php?id=1"> &nbsp; <span class='glyphicon glyphicon-shopping-cart'></span> Comprar</a></li>
					<li  class="active"><a href="cart_items.php"> &nbsp; <span class='fa fa-cart-plus'></span> Carrito</a></li>
					<li><a href="orders.php"> &nbsp; <span class='glyphicon glyphicon-list-alt'></span> Mis Ordenes</a></li>
                ...
                <ul class="nav navbar-nav navbar-right navbar-user">
					...
					<li class="dropdown user-dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class='glyphicon glyphicon-shopping-cart'></span> Total: &#x24; <?php echo $total; ?> </b></a>
        ...
        <div id="page-wrapper">
         ...
         <center><h3> <span class="fa fa-cart-plus"></span> Productos agregados</h3></center>
        </div>
...
include("config.php");
	...
	if($stmt->rowCount() > 0)
	{
			...
			?>
                <tr>
				 ...
				 <td>
                  ...
                  <a class="btn btn-block btn-danger" href="?delete_id=<?php echo $row['order_id']; ?>" title="click for delete" onclick="return confirm('Are you sure to remove this item?')"><span class='glyphicon glyphicon-trash'></span> Quitar</a>
		...
		echo "<tr>";
		echo "<td colspan='3' align='right'>Total:";
		echo "</td>";
		...
		echo "<td>";
		echo "<a class='btn btn-block btn-success' href='?update_id=".$user_id."' ><span class='glyphicon glyphicon-shopping-cart'></span> Ordenar!</a>";
		echo "</td>";
	...
	else
	{
        ...
        <div class="col-xs-12">
        	<div class="alert alert-warning">
            	<span class="glyphicon glyphicon-info-sign"></span> &nbsp; No se encontro el Item  ...
            </div>
        </div>
        <?php
	}
