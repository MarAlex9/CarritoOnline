    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
			 ...
			 <div class="alert alert-danger">
                          ...
                          <center> <h3><strong>Detalles de la compra</strong> </h3></center>
...
include("config.php");
	...
	if($stmt->rowCount() > 0)
	{
		...
		echo "<tr>";
		echo "<td colspan='3' align='right' style='font-size:20px;'>Cliente: ".$user_firstname." ".$user_lastname." | <span style='color:red'>Total:</span>";
		echo "</td>";
		...
		echo "</td>";
		 ...
		 echo "<td>";
		 echo "<a class='btn btn-danger' href='customers.php'><span class='glyphicon glyphicon-backward'></span> Volver<a/>'";
		 echo "</td>";
