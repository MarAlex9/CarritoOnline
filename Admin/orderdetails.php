    ...
    <div id="wrapper">
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                ...
                <li><a href="index.php"> &nbsp; &nbsp; &nbsp; Inicio</a></li>
					...
					<li class="active"><a href="orderdetails.php"> &nbsp; &nbsp; &nbsp; Detalle de ordenes</a></li>
        ...
        <div id="page-wrapper">
		 ...
		 <div class="alert alert-danger">
                          ...
                          <center> <h3><strong>Gestion de ordenes</strong> </h3></center>
	...
	if($stmt->rowCount() > 0)
	{
		while($row=$stmt->fetch(PDO::FETCH_ASSOC))
		{
			...
			?>
				...
				<a class="btn btn-danger" href="?delete_id=<?php echo $row['order_id']; ?>" title="click for delete" onclick="return confirm('Desea eliminar?')">
